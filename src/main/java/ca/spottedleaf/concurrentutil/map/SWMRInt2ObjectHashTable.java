...
import ca.spottedleaf.common.function.BiIntObjectConsumer;
...
public class SWMRInt2ObjectHashTable<V> {
    ...
    protected static final VarHandle SIZE_HANDLE = ConcurrentUtil.getVarHandle(SWMRInt2ObjectHashTable.class, "size", int.class);
    protected static final VarHandle TABLE_HANDLE = ConcurrentUtil.getVarHandle(SWMRInt2ObjectHashTable.class, "table", TableEntry[].class);
     ...
     */
    public SWMRInt2ObjectHashTable() {
     ...
     */
    public SWMRInt2ObjectHashTable(final int capacity) {
     ...
     */
    public SWMRInt2ObjectHashTable(final int capacity, final float loadFactor) {
     ...
     */
    public SWMRInt2ObjectHashTable(final SWMRInt2ObjectHashTable<V> other) {
     ...
     * @param other The specified map.
     */
    public SWMRInt2ObjectHashTable(final int capacity, final SWMRInt2ObjectHashTable<V> other) {
     ...
     * @param other The specified map.
     */
    public SWMRInt2ObjectHashTable(final int capacity, final float loadFactor, final SWMRInt2ObjectHashTable<V> other) {
    ...
    protected final TableEntry<V> getEntryForOpaque(final int key) {
        final int hash = SWMRInt2ObjectHashTable.getHash(key);
    ...
    protected final TableEntry<V> getEntryForPlain(final int key) {
        final int hash = SWMRInt2ObjectHashTable.getHash(key);
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof SWMRInt2ObjectHashTable<?> other)) {
            return false;
        }
    ...
    public String toString() {
        ...
        this.forEach((final int key, final V value) -> {
     ...
     */
    @Override
    public SWMRInt2ObjectHashTable<V> clone() {
        return new SWMRInt2ObjectHashTable<>(this.getTableAcquire().length, this.loadFactor, this);
    }
     ...
     * {@inheritDoc}
     */
    public void forEach(final BiIntObjectConsumer<? super V> action) {
        Objects.requireNonNull(action, "Null action");
    ...
    protected final V put(final int key, final V value, final boolean onlyIfAbsent) {
        final TableEntry<V>[] table = this.getTablePlain();
        final int hash = SWMRInt2ObjectHashTable.getHash(key);
    ...
    protected final V remove(final int key, final int hash) {
        final TableEntry<V>[] table = this.getTablePlain();
    ...
    protected final V remove(final int key, final int hash, final V expect) {
        final TableEntry<V>[] table = this.getTablePlain();
        final int index = (table.length - 1) & hash;
    ...
    public V remove(final int key) {
        return this.remove(key, SWMRInt2ObjectHashTable.getHash(key));
    }

    public boolean remove(final int key, final V expect) {
        return this.remove(key, SWMRInt2ObjectHashTable.getHash(key), expect) != null;
    }

    /**
     * {@inheritDoc}
     */
    public void putAll(final SWMRInt2ObjectHashTable<? extends V> map) {
    ...
    public static final class TableEntry<V> {
        ...
        private TableEntry(final int key, final V value) {
            this.key = key;
            this.value = value;
        }
